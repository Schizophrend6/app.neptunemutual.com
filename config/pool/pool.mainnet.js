...
import { convertFromUnits } from '../../utils/big'
...
export default [
  ...
  },
  {
    ...
    nepRewardAllocation: convertFromUnits(750000000000000000000000),
    token: {
      decimals: 18,
  ...
  },
  {
    ...
    nepRewardAllocation: convertFromUnits(350000000000000000000000),
    token: {
      decimals: 18,
